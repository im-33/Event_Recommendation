...
public class TicketMasterClient {
	...
	private static final String API_KEY = "rAtaRq7Hx4DwubTCYk6dV1nwKXbGsvKx";
...
//		String query = String.format("apikey=%s&latlong=%s,%s&keyword=%s&radius=%s", API_KEY, lat, lon, keyword, DEFAULT_RADIUS);
		...
		try {
			...
			connection.setRequestMethod("GET");  // default就是GET
			connection.connect();
			...
			BufferedReader reader = new BufferedReader(new InputStreamReader(connection.getInputStream()));//可以一段一段读，预先缓存
			String line;
